...
import com.belatrixsf.mymovieapp.view.adapter.MovieRecyclerAdapter
...
class MovieRecyclerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //val myrv = findViewById<RecyclerView>(R.id.movie_recycler_view)
        ...
        moviesRepository.getMovies(object:OnGetMoviesCallback{
            ...
            override fun onError() {
                Toast.makeText(this@MovieRecyclerActivity, "Please check your internet connection.", Toast.LENGTH_SHORT).show()
            }
        })

       // val myAdapter = MovieRecyclerAdapter(this, listMovie)
